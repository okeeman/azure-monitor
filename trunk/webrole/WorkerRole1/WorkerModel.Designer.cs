...
[assembly: EdmRelationshipAttribute("AzureDoctorWorkerModel", "CloudServiceFK1", "AzureDoctorUser", System.Data.Metadata.Edm.RelationshipMultiplicity.One, typeof(WorkerRole1.AzureDoctorUser), "CloudService", System.Data.Metadata.Edm.RelationshipMultiplicity.Many, typeof(WorkerRole1.CloudService), true)]
...
namespace WorkerRole1
{
    ...
    /// No Metadata Documentation available.
    /// </summary>
    [EdmEntityTypeAttribute(NamespaceName="AzureDoctorWorkerModel", Name="AzureDoctorUser")]
    [Serializable()]
    ...
    public partial class AzureDoctorUser : EntityObject
    {
        ...
        [SoapIgnoreAttribute()]
        [DataMemberAttribute()]
        [EdmRelationshipNavigationPropertyAttribute("AzureDoctorWorkerModel", "CloudServiceFK1", "CloudService")]
        public EntityCollection<CloudService> CloudServices
        {
            get
            {
                return ((IEntityWithRelationships)this).RelationshipManager.GetRelatedCollection<CloudService>("AzureDoctorWorkerModel.CloudServiceFK1", "CloudService");
            }
            set
            {
                if ((value != null))
                {
                    ((IEntityWithRelationships)this).RelationshipManager.InitializeRelatedCollection<CloudService>("AzureDoctorWorkerModel.CloudServiceFK1", "CloudService", value);
                }
            }
        }
    ...
    /// No Metadata Documentation available.
    /// </summary>
    [EdmEntityTypeAttribute(NamespaceName="AzureDoctorWorkerModel", Name="CloudService")]
    [Serializable()]
    [DataContractAttribute(IsReference=true)]
    public partial class CloudService : EntityObject
    {
        ...
        public global::System.String SubscriptionID
        {
            ...
            set
            {
                ...
                _SubscriptionID = StructuralObject.SetValidValue(value, true, "SubscriptionID");
        ...
        [SoapIgnoreAttribute()]
        [DataMemberAttribute()]
        [EdmRelationshipNavigationPropertyAttribute("AzureDoctorWorkerModel", "CloudServiceFK1", "AzureDoctorUser")]
        public AzureDoctorUser AzureDoctorUser
        {
            get
            {
                return ((IEntityWithRelationships)this).RelationshipManager.GetRelatedReference<AzureDoctorUser>("AzureDoctorWorkerModel.CloudServiceFK1", "AzureDoctorUser").Value;
            }
            set
            {
                ((IEntityWithRelationships)this).RelationshipManager.GetRelatedReference<AzureDoctorUser>("AzureDoctorWorkerModel.CloudServiceFK1", "AzureDoctorUser").Value = value;
            }
        }
        /// <summary>
        /// No Metadata Documentation available.
        ...
        public EntityReference<AzureDoctorUser> AzureDoctorUserReference
        {
            get
            {
                return ((IEntityWithRelationships)this).RelationshipManager.GetRelatedReference<AzureDoctorUser>("AzureDoctorWorkerModel.CloudServiceFK1", "AzureDoctorUser");
            }
            set
            {
                if ((value != null))
                {
                    ((IEntityWithRelationships)this).RelationshipManager.InitializeRelatedReference<AzureDoctorUser>("AzureDoctorWorkerModel.CloudServiceFK1", "AzureDoctorUser", value);
                }
            }
        }
