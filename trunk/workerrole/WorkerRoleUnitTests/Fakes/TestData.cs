...
// Owen Sweeney 2013
// ----------------------------------------------------------------------------------
// This test data can be inserted into the fake database for unit tests.
// ----------------------------------------------------------------------------------
using System;
    ...
    class TestData
    {
        public static IQueryable<Subscription> Subscriptions
        {
            get
            {
                ...
                var subscription = new Subscription() { SubscriptionRecordID = 7777, SubscriptionName = "FakeSubName", AzureSubscriptionID = "FakeAzureSubID", UserId = 8888, PhoneNumber = "353872802526", Status = "Active" };
        ...
        public static IQueryable<CloudService> CloudServices
        {
            get
            {
                ...
                var cloudService = new CloudService() { CloudServiceID = 9999, SubscriptionRecordID = 7777, CloudServiceName = "FakeCSName", Status = "Active" };
        ...
        public static IQueryable<Certificate> Certificates
        {
            get
            {
                ...
                var certificate = new Certificate() { CertRecordID = 1111, CertificateName = "FakeCert", Thumbprint = "FakeThumbbprint", ExpiryDate = DateTime.Now.AddYears(1) };
