...
namespace WorkerRole1
{
        ...
        public override void Run()
        {
            ...
            while (true)
            {
                try
                {
                    ...
                    {
                        // Create a new RequestResult entity each time through the while loop. This will become a record in the database.
                        // Create a RequestResult entity. There are two partial classes. One is generated by the Entity Framework, the other I have written to include the health request method.
                        ...
                        foreach (var service in cloudServiceCollection)
                        {
                            ...
                            Subscription sub = db.Subscriptions.Single(s => s.SubscriptionRecordID == service.SubscriptionRecordID);
                            ...
                            // Put values into these entity properties. The other properties are polpulated by the MakeHealthRequest method.
                            ...
                            {
                                Trace.WriteLine("Inside if, SMS push", "Information");
                                ...
                                pn.PushSMS("353872802526", message);
                            }
                            else
                            {
                                Trace.WriteLine("Inside else, SMS push", "Information");
    ...
    public class PushNotifications
    {
        ...
        {
            // store username and password in database? encrypt?
